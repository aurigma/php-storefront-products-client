...
namespace Aurigma\Storefront\Products;
...
class Configuration
{
    ...
    {
        $report  = 'PHP SDK (Aurigma\Storefront\Products) Debug Report:' . PHP_EOL;
        $report .= '    OS: ' . php_uname() . PHP_EOL;
        $report .= '    PHP Version: ' . PHP_VERSION . PHP_EOL;
        $report .= '    The version of the OpenAPI document: storefront-v1-products' . PHP_EOL;
